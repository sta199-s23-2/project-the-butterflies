...
\<\<\<\<\<\<\< HEAD Using this data set, there are minimal to no ethical concerns, as this data was collected from a publicaally accessible site. Additionally, all of this data was able be compiled by anyone, as Olympic athletes and their medals are also public information. We did not interview or collect any information ourselves, and their is no private health information or other private information availible in this data. As such, there are no risks to the participants in our data collection and use of this data.
...
Repeat but filter out non-medalists
```{r}
...
facet wrap by category, filter out non medalists, color by medal (fun hex codes!)
...
**NOTE - maybe mutate variable to create height categories?**

*Could also try creating confidence intervals surrounding mean heights in each sport? Not sure but an idea*

*Could also do age categories?*
```{r}
